...
## Guía InkToy ERP/POS
- Analizar por fases: MVP, producción y futuro.
- Delimitar siempre alcance dentro/fuera y opciones con trade-offs reales.
- Evaluar impacto operativo en tienda física: stock, caja, POS, catálogo, documentos y trazabilidad.
- Entregar recomendación clara; no implementar ni fijar estilos finales.
