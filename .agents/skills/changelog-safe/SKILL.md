...
## Guía InkToy ERP/POS
- Separar cambios por módulos: Catálogo, Ventas, POS, Inventario, Compras, Facturación y Reportes.
- Indicar impacto operativo cuando corresponda, sin convertir el changelog en documentación técnica completa.
