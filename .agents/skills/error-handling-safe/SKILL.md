...
## Guía InkToy ERP/POS
- Aplicar a Spring Boot y Angular: mapear excepciones de negocio a HTTP apropiado y mostrar mensajes no técnicos al usuario final.
- Distinguir errores de catálogo, stock, caja, ventas, facturación y permisos.
- Mantener logging seguro con correlación/traceId si aplica; no filtrar datos sensibles.
- No duplicar diseño de API ni UX visual.
