...
public class ProductCleanupPreviewController {
    ...
    private ProductCleanupPreviewResponse toResponse(ProductCleanupPreviewResult result) {
        return new ProductCleanupPreviewResponse(
                ...
                result.purchaseOrders().stream().map(item -> new ProductCleanupPreviewResponse.PurchaseOrderPreview(
                        item.purchaseOrderId(),
                        item.status(),
                        item.itemCount(),
                        item.selectedItemCount(),
                        item.nonSelectedItemCount(),
                        item.purePurchaseOrder(),
                        item.mixedPurchaseOrder()
                )).toList(),
                result.purchaseReceipts().stream().map(item -> new ProductCleanupPreviewResponse.PurchaseReceiptPreview(
                        item.purchaseReceiptId(),
                        item.purchaseOrderId(),
                        item.itemCount(),
                        item.selectedItemCount(),
                        item.nonSelectedItemCount(),
                        item.purePurchaseReceipt(),
                        item.mixedPurchaseReceipt()
                )).toList(),
                ...
                new ProductCleanupPreviewResponse.Summary(
                        ...
                        result.summary().relatedPurchaseOrders(),
                        result.summary().purePurchaseOrders(),
                        result.summary().mixedPurchaseOrders(),
                        result.summary().relatedPurchaseReceipts(),
                        result.summary().purePurchaseReceipts(),
                        result.summary().mixedPurchaseReceipts(),
