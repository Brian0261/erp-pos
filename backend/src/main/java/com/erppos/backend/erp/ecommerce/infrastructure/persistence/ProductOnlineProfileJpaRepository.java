...
public interface ProductOnlineProfileJpaRepository extends JpaRepository<ProductOnlineProfileEntity, Long>, JpaSpecificationExecutor<ProductOnlineProfileEntity> {
